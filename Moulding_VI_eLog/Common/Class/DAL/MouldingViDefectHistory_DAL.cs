...
{
	/// <summary>
	/// 数据访问类:MouldingViDefectHistory_DAL
	/// </summary>
	public class MouldingViDefectHistory_DAL
	{
		public MouldingViDefectHistory_DAL()
		{}
		#region  Method
		...
		public void Add(Common.Model.MouldingViDefectHistory_Model model)
		{
			...
			strSql.Append("insert into MouldingViDefectHistory(");
		...
		public SqlCommand AddCommand(Common.Model.MouldingViDefectHistory_Model model)
		{
			...
			SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@SupervisorCheckTime", SqlDbType.DateTime2,8),
                    new SqlParameter("@partNumberAll", SqlDbType.VarChar,500)};
            DBHelp.Reports.LogFile.DebugLog("AUTOCODE","NameSpace:Common.DAL" , "Class:MouldingViDefectHistory_DAL" , "Function:		public SqlCommand AddCommand(Common.Model.MouldingViDefectHistory_Model model)"  + "TableName:MouldingViDefectHistory" , ";id = "+ (model.id == null ? "" : model.id.ToString()) + ";trackingID = "+ (model.trackingID == null ? "" : model.trackingID.ToString()) + ";machineID = "+ (model.machineID == null ? "" : model.machineID.ToString()) + ";dateTime = "+ (model.dateTime == null ? "" : model.dateTime.ToString()) + ";partNumber = "+ (model.partNumber == null ? "" : model.partNumber.ToString()) + ";jigNo = "+ (model.jigNo == null ? "" : model.jigNo.ToString()) + ";model = "+ (model.model == null ? "" : model.model.ToString()) + ";cavityCount = "+ (model.cavityCount == null ? "" : model.cavityCount.ToString()) + ";userName = "+ (model.userName == null ? "" : model.userName.ToString()) + ";userID = "+ (model.userID == null ? "" : model.userID.ToString()) + ";startTime = "+ (model.startTime == null ? "" : model.startTime.ToString()) + ";stopTime = "+ (model.stopTime == null ? "" : model.stopTime.ToString()) + ";day = "+ (model.day == null ? "" : model.day.ToString()) + ";shift = "+ (model.shift == null ? "" : model.shift.ToString()) + ";status = "+ (model.status == null ? "" : model.status.ToString()) + ";matPart01 = "+ (model.matPart01 == null ? "" : model.matPart01.ToString()) + ";matPart02 = "+ (model.matPart02 == null ? "" : model.matPart02.ToString()) + ";matLot01 = "+ (model.matLot01 == null ? "" : model.matLot01.ToString()) + ";matLot02 = "+ (model.matLot02 == null ? "" : model.matLot02.ToString()) + ";defectCodeID = "+ (model.defectCodeID == null ? "" : model.defectCodeID.ToString()) + ";defectCode = "+ (model.defectCode == null ? "" : model.defectCode.ToString()) + ";rejectQty = "+ (model.rejectQty == null ? "" : model.rejectQty.ToString()) + ";rejectQtyHour01 = "+ (model.rejectQtyHour01 == null ? "" : model.rejectQtyHour01.ToString()) + ";rejectQtyHour02 = "+ (model.rejectQtyHour02 == null ? "" : model.rejectQtyHour02.ToString()) + ";rejectQtyHour03 = "+ (model.rejectQtyHour03 == null ? "" : model.rejectQtyHour03.ToString()) + ";rejectQtyHour04 = "+ (model.rejectQtyHour04 == null ? "" : model.rejectQtyHour04.ToString()) + ";rejectQtyHour05 = "+ (model.rejectQtyHour05 == null ? "" : model.rejectQtyHour05.ToString()) + ";rejectQtyHour06 = "+ (model.rejectQtyHour06 == null ? "" : model.rejectQtyHour06.ToString()) + ";rejectQtyHour07 = "+ (model.rejectQtyHour07 == null ? "" : model.rejectQtyHour07.ToString()) + ";rejectQtyHour08 = "+ (model.rejectQtyHour08 == null ? "" : model.rejectQtyHour08.ToString()) + ";rejectQtyHour09 = "+ (model.rejectQtyHour09 == null ? "" : model.rejectQtyHour09.ToString()) + ";rejectQtyHour10 = "+ (model.rejectQtyHour10 == null ? "" : model.rejectQtyHour10.ToString()) + ";rejectQtyHour11 = "+ (model.rejectQtyHour11 == null ? "" : model.rejectQtyHour11.ToString()) + ";rejectQtyHour12 = "+ (model.rejectQtyHour12 == null ? "" : model.rejectQtyHour12.ToString()) + ";lastUpdatedTime = "+ (model.lastUpdatedTime == null ? "" : model.lastUpdatedTime.ToString()) + ";remarks = "+ (model.remarks == null ? "" : model.remarks.ToString()) + "");
			parameters[0].Value = model.id == null ? (object)DBNull.Value : model.id ;
			parameters[1].Value = model.trackingID == null ? (object)DBNull.Value : model.trackingID ;
			parameters[2].Value = model.machineID == null ? (object)DBNull.Value : model.machineID ;
			parameters[3].Value = model.dateTime == null ? (object)DBNull.Value : model.dateTime ;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update MouldingViDefectHistory set ");
			strSql.Append("id=@id,");
            ...
            parameters[46].Value = model.SupervisorCheckTime == null ? (object)DBNull.Value : model.SupervisorCheckTime;
            parameters[47].Value = model.partnumberall == null ? (object)DBNull.Value : model.partnumberall;
            DBHelp.Reports.LogFile.DebugLog("AUTOCODE","NameSpace:Common.DAL" , "Class:MouldingViDefectHistory_DAL" , "Function:		public bool Update(Common.Model.MouldingViDefectHistory_Model model)"  + "TableName:MouldingViDefectHistory" , ";id = "+ (model.id == null ? "" : model.id.ToString() ) + ";trackingID = "+ (model.trackingID == null ? "" : model.trackingID.ToString() ) + ";machineID = "+ (model.machineID == null ? "" : model.machineID.ToString() ) + ";dateTime = "+ (model.dateTime == null ? "" : model.dateTime.ToString() ) + ";partNumber = "+ (model.partNumber == null ? "" : model.partNumber.ToString() ) + ";jigNo = "+ (model.jigNo == null ? "" : model.jigNo.ToString() ) + ";model = "+ (model.model == null ? "" : model.model.ToString() ) + ";cavityCount = "+ (model.cavityCount == null ? "" : model.cavityCount.ToString() ) + ";userName = "+ (model.userName == null ? "" : model.userName.ToString() ) + ";userID = "+ (model.userID == null ? "" : model.userID.ToString() ) + ";startTime = "+ (model.startTime == null ? "" : model.startTime.ToString() ) + ";stopTime = "+ (model.stopTime == null ? "" : model.stopTime.ToString() ) + ";day = "+ (model.day == null ? "" : model.day.ToString() ) + ";shift = "+ (model.shift == null ? "" : model.shift.ToString() ) + ";status = "+ (model.status == null ? "" : model.status.ToString() ) + ";matPart01 = "+ (model.matPart01 == null ? "" : model.matPart01.ToString() ) + ";matPart02 = "+ (model.matPart02 == null ? "" : model.matPart02.ToString() ) + ";matLot01 = "+ (model.matLot01 == null ? "" : model.matLot01.ToString() ) + ";matLot02 = "+ (model.matLot02 == null ? "" : model.matLot02.ToString() ) + ";defectCodeID = "+ (model.defectCodeID == null ? "" : model.defectCodeID.ToString() ) + ";defectCode = "+ (model.defectCode == null ? "" : model.defectCode.ToString() ) + ";rejectQty = "+ (model.rejectQty == null ? "" : model.rejectQty.ToString() ) + ";rejectQtyHour01 = "+ (model.rejectQtyHour01 == null ? "" : model.rejectQtyHour01.ToString() ) + ";rejectQtyHour02 = "+ (model.rejectQtyHour02 == null ? "" : model.rejectQtyHour02.ToString() ) + ";rejectQtyHour03 = "+ (model.rejectQtyHour03 == null ? "" : model.rejectQtyHour03.ToString() ) + ";rejectQtyHour04 = "+ (model.rejectQtyHour04 == null ? "" : model.rejectQtyHour04.ToString() ) + ";rejectQtyHour05 = "+ (model.rejectQtyHour05 == null ? "" : model.rejectQtyHour05.ToString() ) + ";rejectQtyHour06 = "+ (model.rejectQtyHour06 == null ? "" : model.rejectQtyHour06.ToString() ) + ";rejectQtyHour07 = "+ (model.rejectQtyHour07 == null ? "" : model.rejectQtyHour07.ToString() ) + ";rejectQtyHour08 = "+ (model.rejectQtyHour08 == null ? "" : model.rejectQtyHour08.ToString() ) + ";rejectQtyHour09 = "+ (model.rejectQtyHour09 == null ? "" : model.rejectQtyHour09.ToString() ) + ";rejectQtyHour10 = "+ (model.rejectQtyHour10 == null ? "" : model.rejectQtyHour10.ToString() ) + ";rejectQtyHour11 = "+ (model.rejectQtyHour11 == null ? "" : model.rejectQtyHour11.ToString() ) + ";rejectQtyHour12 = "+ (model.rejectQtyHour12 == null ? "" : model.rejectQtyHour12.ToString() ) + ";lastUpdatedTime = "+ (model.lastUpdatedTime == null ? "" : model.lastUpdatedTime.ToString() ) + ";remarks = "+ (model.remarks == null ? "" : model.remarks.ToString() ) + "");
		...
		public SqlCommand UpdateCommand(Common.Model.MouldingViDefectHistory_Model model)
		{
            ...
            parameters[46].Value = model.SupervisorCheckTime == null ? (object)DBNull.Value : model.SupervisorCheckTime;
            parameters[47].Value = model.partnumberall == null ? (object)DBNull.Value : model.partnumberall;
            DBHelp.Reports.LogFile.DebugLog("AUTOCODE","NameSpace:Common.DAL" , "Class:MouldingViDefectHistory_DAL" , "Function:		public SqlCommand UpdateCommand(Common.Model.MouldingViDefectHistory_Model model)"  + "TableName:MouldingViDefectHistory" , ";id = "+ (model.id == null ? "" : model.id.ToString()) + ";trackingID = "+ (model.trackingID == null ? "" : model.trackingID.ToString()) + ";machineID = "+ (model.machineID == null ? "" : model.machineID.ToString()) + ";dateTime = "+ (model.dateTime == null ? "" : model.dateTime.ToString()) + ";partNumber = "+ (model.partNumber == null ? "" : model.partNumber.ToString()) + ";jigNo = "+ (model.jigNo == null ? "" : model.jigNo.ToString()) + ";model = "+ (model.model == null ? "" : model.model.ToString()) + ";cavityCount = "+ (model.cavityCount == null ? "" : model.cavityCount.ToString()) + ";userName = "+ (model.userName == null ? "" : model.userName.ToString()) + ";userID = "+ (model.userID == null ? "" : model.userID.ToString()) + ";startTime = "+ (model.startTime == null ? "" : model.startTime.ToString()) + ";stopTime = "+ (model.stopTime == null ? "" : model.stopTime.ToString()) + ";day = "+ (model.day == null ? "" : model.day.ToString()) + ";shift = "+ (model.shift == null ? "" : model.shift.ToString()) + ";status = "+ (model.status == null ? "" : model.status.ToString()) + ";matPart01 = "+ (model.matPart01 == null ? "" : model.matPart01.ToString()) + ";matPart02 = "+ (model.matPart02 == null ? "" : model.matPart02.ToString()) + ";matLot01 = "+ (model.matLot01 == null ? "" : model.matLot01.ToString()) + ";matLot02 = "+ (model.matLot02 == null ? "" : model.matLot02.ToString()) + ";defectCodeID = "+ (model.defectCodeID == null ? "" : model.defectCodeID.ToString()) + ";defectCode = "+ (model.defectCode == null ? "" : model.defectCode.ToString()) + ";rejectQty = "+ (model.rejectQty == null ? "" : model.rejectQty.ToString()) + ";rejectQtyHour01 = "+ (model.rejectQtyHour01 == null ? "" : model.rejectQtyHour01.ToString()) + ";rejectQtyHour02 = "+ (model.rejectQtyHour02 == null ? "" : model.rejectQtyHour02.ToString()) + ";rejectQtyHour03 = "+ (model.rejectQtyHour03 == null ? "" : model.rejectQtyHour03.ToString()) + ";rejectQtyHour04 = "+ (model.rejectQtyHour04 == null ? "" : model.rejectQtyHour04.ToString()) + ";rejectQtyHour05 = "+ (model.rejectQtyHour05 == null ? "" : model.rejectQtyHour05.ToString()) + ";rejectQtyHour06 = "+ (model.rejectQtyHour06 == null ? "" : model.rejectQtyHour06.ToString()) + ";rejectQtyHour07 = "+ (model.rejectQtyHour07 == null ? "" : model.rejectQtyHour07.ToString()) + ";rejectQtyHour08 = "+ (model.rejectQtyHour08 == null ? "" : model.rejectQtyHour08.ToString()) + ";rejectQtyHour09 = "+ (model.rejectQtyHour09 == null ? "" : model.rejectQtyHour09.ToString()) + ";rejectQtyHour10 = "+ (model.rejectQtyHour10 == null ? "" : model.rejectQtyHour10.ToString()) + ";rejectQtyHour11 = "+ (model.rejectQtyHour11 == null ? "" : model.rejectQtyHour11.ToString()) + ";rejectQtyHour12 = "+ (model.rejectQtyHour12 == null ? "" : model.rejectQtyHour12.ToString()) + ";lastUpdatedTime = "+ (model.lastUpdatedTime == null ? "" : model.lastUpdatedTime.ToString()) + ";remarks = "+ (model.remarks == null ? "" : model.remarks.ToString()) + "");
			return DBHelp.SqlDB.generateCommand(strSql.ToString(),parameters);
		}
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from MouldingViDefectHistory ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
};

			 DBHelp.Reports.LogFile.DebugLog("AUTOCODE","NameSpace:Common.DAL" , "Class:MouldingViDefectHistory_DAL" , "Function:		public bool Delete()"  + "TableName:MouldingViDefectHistory" , "");
			int rows=DBHelp.SqlDB.ExecuteSql(strSql.ToString(),parameters);
			if (rows > 0)
			{
				return true;
		...
		public SqlCommand DeleteCommand()
		{
			...
			SqlParameter[] parameters = {
			 ...
			 DBHelp.Reports.LogFile.DebugLog("AUTOCODE","NameSpace:Common.DAL" , "Class:MouldingViDefectHistory_DAL" , "Function:		public SqlCommand DeleteCommand()"  + "TableName:MouldingViDefectHistory" , "");
			return DBHelp.SqlDB.generateCommand(strSql.ToString(),parameters);
		}
		/// <summary>
		/// 删除一条数据
		...
		public SqlCommand DeleteAllCommand( )
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from MouldingViDefectHistory ");
			 DBHelp.Reports.LogFile.DebugLog("AUTOCODE","NameSpace:Common.DAL" , "Class:MouldingViDefectHistory_DAL" , "Function:		public SqlCommand DeleteAllCommand( )"  + "TableName:MouldingViDefectHistory" , "");
		...
		public Common.Model.MouldingViDefectHistory_Model GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,trackingID,machineID,dateTime,partNumber,jigNo,model,cavityCount,userName,userID,startTime,stopTime,day,shift,status,matPart01,matPart02,matLot01,matLot02,defectCodeID,defectCode,rejectQty,rejectQtyHour01,rejectQtyHour02,rejectQtyHour03,rejectQtyHour04,rejectQtyHour05,rejectQtyHour06,rejectQtyHour07,rejectQtyHour08,rejectQtyHour09,rejectQtyHour10,rejectQtyHour11,rejectQtyHour12,lastUpdatedTime,remarks,QCNGQTY,Material_MHCheck,Material_MHCheckTime,Material_Opcheck,Material_OpCheckTime,Material_LeaderCheck,Material_LeaderCheckTime,LeaderCheck,LeaderCheckTime,SupervisorCheck,SupervisorCheckTime,partNumberAll from MouldingViDefectHistory ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
};

			 DBHelp.Reports.LogFile.DebugLog("AUTOCODE","NameSpace:Common.DAL" , "Class:MouldingViDefectHistory_DAL" , "Function:		public Common.Model.MouldingViDefectHistory_Model GetModel()"  + "TableName:MouldingViDefectHistory" , "");
			Common.Model.MouldingViDefectHistory_Model model=new Common.Model.MouldingViDefectHistory_Model();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM MouldingViDefectHistory ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "MouldingViDefectHistory";
			parameters[1].Value = "";
