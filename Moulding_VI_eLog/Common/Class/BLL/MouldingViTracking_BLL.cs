...
{
	/// <summary>
	/// MouldingViTracking_BLL
	/// </summary>
	public class MouldingViTracking_BLL
	{
		private readonly Common.DAL.MouldingViTracking_DAL dal=new Common.DAL.MouldingViTracking_DAL();
		public MouldingViTracking_BLL()
		{}
		#region  Method
		/// <summary>
		/// 是否存在该记录
		...
		/// 获得数据列表
		/// </summary>
		public List<Common.Model.MouldingViTracking_Model> GetModelList(string strWhere)
		{
        ...
        /// 获得数据列表
        /// </summary>
        public List<Common.Model.MouldingViTracking_Model> DataTableToList(DataTable dt)
		{
			List<Common.Model.MouldingViTracking_Model> modelList = new List<Common.Model.MouldingViTracking_Model>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Common.Model.MouldingViTracking_Model model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Common.Model.MouldingViTracking_Model();
		...
		/// 获得前几行数据
		/// </summary>
		public Common.Model.MouldingViTracking_Model CopyObj(Common.Model.MouldingViTracking_Model objModel )
		{
			Common.Model.MouldingViTracking_Model model;
			model = new Common.Model.MouldingViTracking_Model();
        ...
        public MouldingViTracking_Model GetModel_ByDayShiftPartMachine(DateTime curDay, string curShift, string partNumber, string machineID)
        {
            MouldingViTracking_Model objVi = new MouldingViTracking_Model();
        ...
        public MouldingViTracking_Model GetModel_ByDayShiftAllPartMachine(DateTime curDay, string curShift, string AllpartNumber, string machineID)
        {
            MouldingViTracking_Model objVi = new MouldingViTracking_Model();
            DataSet ds = dal.GetModel_ByDayShiftAllPartMachine(curDay, curShift, AllpartNumber, machineID);
            if (ds == null || ds.Tables.Count == 0 || ds.Tables[0].Rows.Count == 0)
            {
                objVi = null;
            }
        ...
        public MouldingViTracking_Model GetModel_ByMachine(string machineID)
        {
            MouldingViTracking_Model objVi = new MouldingViTracking_Model();
            DataSet ds = dal.GetModel_ByMachine(machineID);
            if (ds == null || ds.Tables.Count == 0 || ds.Tables[0].Rows.Count == 0)
            {
                objVi = null;
            }
        ...
        public MouldingViTracking_Model GetModel_ByDayShiftAllPartMachine_old(DateTime curDay, string curShift, string AllpartNumber, string machineID)
        {
            MouldingViTracking_Model objVi = new MouldingViTracking_Model();
            DataSet ds = dal.GetModel_ByDayShiftAllPartMachine_old(curDay, curShift, AllpartNumber, machineID);
            if (ds == null || ds.Tables.Count == 0 || ds.Tables[0].Rows.Count == 0)
            {
                objVi = null;
            }
        ...
        public MouldingViTracking_Model GetModel_ByTrackingID(string trackingID)
        {
            List<Common.Model.MouldingViTracking_Model> objTckList = new List<MouldingViTracking_Model>();
            objTckList = GetModelList(" TrackingID = '" + trackingID + "'");
            if (objTckList.Count ==0)
            { return null;
            }
            else
            {
