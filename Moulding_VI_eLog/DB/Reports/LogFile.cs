        ...
        public static void Log(string LogType, string msg)
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                        path = System.IO.Path.Combine(System.Web.HttpContext.Current.Server.MapPath(".\\"), "LOG"); //for web application
                    }
                    else
                    {
                        path = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "LOG"); //for winform application
                    }
                }
                catch
                {
                    path = ".\\Log\\"; //for windows application
                }
                ...
                file = System.IO.Path.Combine( path , LogType + "(" + DateTime.Now.ToString(datePatt) + ").txt");
